 ...
 *
 * Usage:  node scripts/build-image.mjs [outDir] [--arch=riscv64|amd64]
 *         (defaults: ./public/alpine, riscv64)
 */
...
const SRC_ARCH = archFlag ? archFlag.split("=")[1] : "riscv64"; // must match the emulator (public/out.wasm.gzip)
const LABEL_ARCH = "amd64"; // must match the mounter's hardcoded default
const BUILDER = "c2woci";
const SCRIPTS = dirname(fileURLToPath(import.meta.url));
const OUT = args.find((a) => !a.startsWith("--")) || join(SCRIPTS, "..", "public", "alpine");
